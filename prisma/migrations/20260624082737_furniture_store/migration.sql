-- CreateEnum
CREATE TYPE "FurnitureCategory" AS ENUM ('CHAIR', 'TABLE', 'SOFA', 'BED', 'CABINET');
...
-- AddForeignKey
ALTER TABLE "CartItem" ADD CONSTRAINT "CartItem_furnitureId_fkey" FOREIGN KEY ("furnitureId") REFERENCES "Furniture"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
